'use client';
import { useTableState, useTableColumnResizeState, Column } from 'react-stately/useTableState';
...
import { useTableColumnResize, useTable, useTableRowGroup, useTableColumnHeader, useTableHeaderRow, useTableRow, useTableCell, useTableSelectionCheckbox, useTableSelectAllCheckbox } from 'react-aria/useTable';
...
import { VirtualizerItem, layoutInfoToStyle } from 'react-aria/private/virtualizer/VirtualizerItem';
...
import { TableLayout, Rect, LayoutInfo, useVirtualizerState } from 'react-stately/useVirtualizerState';
...
function DragPreview(props) {
  ...
  return /*#__PURE__*/ /* TODO: export as `DragPreview` from "@keystar/ui/drag-and-drop" for use here and in the list view */jsxs(Flex, {
    alignItems: "center",
    ...
    children: [/*#__PURE__*/jsx(Text, {
      children: itemText
    }), isDraggingMultiple && /*#__PURE__*/jsx(Flex, {
      alignItems: "center",
...
function Resizer(props, forwardedRef) {
  ...
  let {
    inputProps,
    resizerProps
  } = useTableColumnResize(mergeProps(props, {
...
function CursorOverlay(props) {
  ...
  return show ? /*#__PURE__*/ReactDOM.createPortal(children, (_getContainer = getContainer === null || getContainer === void 0 ? void 0 : getContainer()) !== null && _getContainer !== void 0 ? _getContainer : document.body) : null;
}
...
class TableViewLayout extends TableLayout {
  ...
  getDropTargetFromPoint(x, y, isValidDropTarget) {
    ...
    let headerRowHeight = (_layout$getVisibleLay = this.virtualizer.layout.getVisibleLayoutInfos(new Rect(x, y, 1, 1)).find(info => info.type === 'headerrow')) === null || _layout$getVisibleLay === void 0 ? void 0 : _layout$getVisibleLay.rect.height;
    if (headerRowHeight) {
      y -= headerRowHeight;
    }
...
function TableView(props) {
  ...
  let onResizeEnd = useCallback(widths => {
    ...
    setIsResizing(false);
    propsOnResizeEnd === null || propsOnResizeEnd === void 0 || propsOnResizeEnd(widths);
