...
import { forwardRef, useMemo, useLayoutEffect, useRef, useState, useEffect } from 'react';
...
const ButtonGroup = /*#__PURE__*/forwardRef(function ButtonGroup(props, forwardedRef) {
  ...
  let checkForOverflow = useMemo(() => {
    return getCheckForOverflow(domRef, orientation, scale, setHasOverflow);
...
const BaseButton$1 = /*#__PURE__*/forwardRef(function Button(props, forwardedRef) {
  ...
  return /*#__PURE__*/jsxs("button", {
    ...
    children: [children, isProgressVisible && /*#__PURE__*/jsx(ProgressCircle, {
      "aria-atomic": "false",
      "aria-live": "assertive",
