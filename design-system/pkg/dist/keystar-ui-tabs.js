...
import { useTabList, useTabPanel, useTab } from 'react-aria/useTabList';
import { filterDOMProps } from 'react-aria/filterDOMProps';
import { mergeProps } from 'react-aria/mergeProps';
import { useId } from 'react-aria/useId';
import React, { useContext, useEffect, createElement, useRef, useState, useCallback, useLayoutEffect } from 'react';
...
function TabPanels(props) {
  ...
  const selectedItem = tabListState !== null && tabListState !== void 0 && tabListState.selectedKey ? collection.getItem(tabListState.selectedKey) : null;
