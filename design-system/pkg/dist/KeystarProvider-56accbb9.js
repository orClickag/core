...
import { useLocale, I18nProvider } from 'react-aria/I18nProvider';
...
import { R as RouterContextProvider } from './context-f808ea2f.js';
import { resetClassName, injectGlobal, css, tokenSchema, useMediaQuery, useMatchedBreakpoints, useStyleProps, BreakpointProvider } from '@keystar/ui/style';
import { forwardRefWithAs } from '@keystar/ui/utils/ts';
import { THEME_DEFAULT, SCHEME_AUTO, SCHEME_LIGHT, SCHEME_DARK } from '@keystar/ui/primitives';
 ...
 */
const documentReset = (background = 'canvas') => css`
  html& {
...
const KeystarProvider = forwardRefWithAs(function KeystarProvider(props, forwardedRef) {
  ...
  if (!prevContext || props.elementType || props.locale || colorScheme !== prevContext.colorScheme || scale !== prevContext.scale || Object.keys(domProps).length > 0 || otherProps.UNSAFE_className || styleProps.style && Object.keys(styleProps.style).length > 0) {
    ...
    contents = /*#__PURE__*/jsx(ProviderWrapper, {
      ref: forwardedRef,
      ...props,
      style: {
  ...
  if (router) {
    contents = /*#__PURE__*/jsx(RouterContextProvider, {
      router: router,
...
const ProviderWrapper = forwardRefWithAs(function ProviderWrapper(props, forwardedRef) {
...
export { KeystarProvider as K, useProviderProps as a, documentElementClasses as d, useProvider as u };
