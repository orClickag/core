...
import { Overlay as Overlay$1, DismissButton } from 'react-aria/Overlay';
import { KeystarProvider } from '@keystar/ui/core';
import { c as cloneValidElement } from './children-8bde6fe1.js';
...
const Transition = function Transition(props) {
  ...
  return (_cloneValidElement = cloneValidElement(props.children, {
...
function useTransition(props) {
  ...
  }, [isOpenProp, isOpen, nodeRef, onEnter, onEntering, onExit, onExiting, onEntered, onExited]);
  return {
    isOpen,
    setIsOpen
  };
...
const Overlay = /*#__PURE__*/forwardRef(function Overlay(props, forwardedRef) {
  ...
  return /*#__PURE__*/jsx(Overlay$1, {
    ...
    children: /*#__PURE__*/jsx(KeystarProvider, {
      ...
      ,
      isDisabled: false,
      children: (_cloneValidElement = cloneValidElement(props.children, {
        isOpen: isOpen === 'mounting' ? false : props.isOpen
      })) !== null && _cloneValidElement !== void 0 ? _cloneValidElement : props.children
    })
  });
...
const PopoverWrapper = /*#__PURE__*/forwardRef(function PopoverWrapper(props, forwardedRef) {
  var _popoverProps$style, _popoverProps$style2;
  let {
    children,
    isOpen,
    hideArrow,
  ...
  return /*#__PURE__*/jsxs("div", {
    ...
    children: [!isNonModal && /*#__PURE__*/jsx(Blanket, {
      ...
      style: {
        ...
        '--popover-max-height': typeof ((_popoverProps$style = popoverProps.style) === null || _popoverProps$style === void 0 ? void 0 : _popoverProps$style.maxHeight) === 'number' ? `${popoverProps.style.maxHeight}px` : (_popoverProps$style2 = popoverProps.style) === null || _popoverProps$style2 === void 0 ? void 0 : _popoverProps$style2.maxHeight
      },
      ref: popoverRef,
      role: "presentation",
