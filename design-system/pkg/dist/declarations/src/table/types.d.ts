...
import { ColumnSize, TableProps as ReactAriaTableProps } from 'react-stately/useTableState';
...
} & AriaLabelingProps & DOMProps & TableCosmeticConfig & ReactAriaTableProps<T> & BaseStyleProps & DOMProps;
