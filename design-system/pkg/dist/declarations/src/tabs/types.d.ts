import { AriaLabelingProps, CollectionChildren, DOMProps, Key, SingleSelection, Orientation } from '@react-types/shared';
...
} & AriaLabelingProps & Omit<SingleSelection, 'selectedKey' | 'defaultSelectedKey'> & {
    selectedKey?: Key;
