...
import { DOMProps, InputBase, FocusableProps, Orientation } from '@react-types/shared';
...
} & ToggleProps & BaseStyleProps & DOMProps;
export type CheckboxGroupProps = AriaCheckboxGroupProps & FieldProps & BaseStyleProps & {
