...
export declare const cx: (...classNames: Array<ClassNamesArg>) => string, css: {
    ...
    (template: TemplateStringsArray, ...args: Array<CSSInterpolation>): void;
    (...args: Array<CSSInterpolation>): void;
}, cache: EmotionCache;
