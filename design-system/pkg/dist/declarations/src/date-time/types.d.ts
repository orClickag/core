...
export type DateFieldProps<T extends DateValue> = DateFieldBase<T> & FocusableProps & ValueBase<T | null, MappedDateValue<T> | null> & FieldProps;
export type TimeFieldProps<T extends TimeValue> = {
    ...
    maxValue?: TimeValue;
} & FocusableProps & ValueBase<T | null, MappedTimeValue<T> | null> & FieldProps;
type DatePickerBase<T extends DateValue> = {
     ...
     */
    shouldFlip?: boolean;
} & DateFieldBase<T> & FocusableProps & FieldProps;
export type DatePickerProps<T extends DateValue> = DatePickerBase<T> & AriaDatePickerProps<T> & ValueBase<T | null, MappedDateValue<T> | null>;
export type DateRangePickerProps<T extends DateValue> = DatePickerBase<T> & AriaDateRangePickerProps<T> & ValueBase<RangeValue<T> | null, RangeValue<MappedDateValue<T>>>;
export {};
