...
import { AsyncLoadable, CollectionBase, FocusableProps, Key, LoadingState, MultipleSelection, TextInputBase, Validation } from '@react-types/shared';
...
export type ComboboxProps<T> = Omit<AriaComboBoxProps<T>, 'menuTrigger' | keyof FieldProps> & FieldProps & BaseStyleProps & Omit<AsyncLoadable, 'isLoading'> & CommonProps;
...
export interface ComboboxMultiProps<T> extends CollectionBase<T>, Omit<MultipleSelection, 'disallowEmptySelection'>, Omit<AsyncLoadable, 'isLoading'>, TextInputBase, FocusableProps<HTMLInputElement>, Validation<ComboboxMultiValidationValue>, CommonProps, FieldProps {
