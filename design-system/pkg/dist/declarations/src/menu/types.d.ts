...
import type { Alignment, AriaLabelingProps, CollectionBase, DOMProps, DisabledBehavior } from '@react-types/shared';
import type { ReactElement } from 'react';
import type { BaseStyleProps } from "../../dist/keystar-ui-style.js";
import type { ActionButtonProps } from "../../dist/keystar-ui-button.js";
export type MenuProps<T> = {
    /** Whether `disabledKeys` applies to all interactions, or only selection. */
    disabledBehavior?: DisabledBehavior;
} & AriaMenuProps<T> & BaseStyleProps;
...
} & CollectionBase<T> & Omit<MenuTriggerProps, 'children'> & Pick<ActionButtonProps, 'prominence'> & BaseStyleProps & DOMProps & AriaLabelingProps;
