import { StyleResolver, FlexStyleProps, GridStyleProps, LooseSizeDimension } from "../../dist/keystar-ui-style.js";
export declare function useFlexStyleProps(props: FlexStyleProps): Pick<import("react").HTMLAttributes<HTMLElement>, "style" | "className">;
export declare function useFlexProps(props: FlexStyleProps): {
...
export declare const flexStyleProps: {
    direction: ["flexDirection", StyleResolver];
    inline: ["display", StyleResolver];
    wrap: ["flexWrap", StyleResolver];
    gap: ["gap", StyleResolver];
    columnGap: ["columnGap", StyleResolver];
    rowGap: ["rowGap", StyleResolver];
    alignContent: ["alignContent", StyleResolver];
    alignItems: ["alignItems", StyleResolver];
    justifyContent: ["justifyContent", StyleResolver];
};
type FractionUnit = `${number}fr`;
type GridDimension = LooseSizeDimension | FractionUnit;
export declare function useGridStyleProps(props: GridStyleProps): Pick<import("react").HTMLAttributes<HTMLElement>, "style" | "className">;
export declare function useGrid(props: GridStyleProps): {
    style?: import("react").CSSProperties | undefined;
    className?: string | undefined;
    defaultChecked?: boolean | undefined;
    defaultValue?: string | number | readonly string[] | undefined;
...
export declare const gridStyleProps: {
    inline: ["display", StyleResolver];
    autoFlow: ["gridAutoFlow", StyleResolver];
    autoColumns: ["gridAutoColumns", StyleResolver];
    autoRows: ["gridAutoRows", StyleResolver];
    areas: ["gridTemplateAreas", StyleResolver];
    columns: ["gridTemplateColumns", StyleResolver];
    rows: ["gridTemplateRows", StyleResolver];
    justifyItems: ["justifyItems", StyleResolver];
    justifyContent: ["justifyContent", StyleResolver];
    alignItems: ["alignItems", StyleResolver];
    alignContent: ["alignContent", StyleResolver];
    gap: ["gap", StyleResolver];
 ...
 */
export declare function repeat(count: number | 'auto-fill' | 'auto-fit', repeat: GridDimension): string;
/**
 ...
 */
export declare function minmax(min: GridDimension, max: GridDimension): string;
/**
 ...
 */
export declare function fitContent(dimension: GridDimension): string;
export {};
