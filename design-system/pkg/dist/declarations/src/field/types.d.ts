...
import { HTMLTag } from "../../dist/keystar-ui-utils-ts.js";
...
export type FieldRenderProp = (inputProps: FieldRenderInputProps) => ReactElement;
export type FieldProps = Pick<FieldPrimitiveProps, 'contextualHelp' | 'description' | 'errorMessage' | 'isRequired' | 'label' | 'labelElementType'> & InputBase & AriaLabelingProps & BaseStyleProps & DOMProps;
