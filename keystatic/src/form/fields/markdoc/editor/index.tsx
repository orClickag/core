...
export const Editor = forwardRef(function Editor(
  ...
  return (
    <MarkdocPreviewProvider previewUrl={previewUrl}>
      <PreviewSurface
...
const PreviewSurface = forwardRef(function PreviewSurface(
  props: {
    editorContext: { id: string };
    entryLayoutPane: ReturnType<typeof useEntryLayoutSplitPaneContext>;
    id: string;
    onChange: (state: EditorState) => void;
  ...
  return (
    <EditorContextProvider value={props.editorContext}>
      <ProseMirrorEditor
        value={props.value}
      ...
      >
        <Box
          ...
          data-preview={preview?.isPreview ? 'true' : 'false'}
        ...
        >
          ...
          />
          <div
            aria-hidden={preview?.isPreview || undefined}
            inert={preview?.isPreview ? '' : undefined}
            hidden={preview?.isPreview}
            style={{
              display: preview?.isPreview ? 'none' : undefined,
            }}
          >
            <ProseMirrorEditable
              {...props.props}
          ...
          {preview?.isPreview && <MarkdocPreviewPanel />}
        </Box>
